...
describe('Round', function() {
    ...
    it('should update turns counter, evaluate guess, and give feedback', function() {
        const card1 = new Card(1, 'What allows you to define a set of related information using key-value pairs?', ['object', 'array', 'function'], 'object');
        const card2 = new Card(2, 'What is a comma-separated list of related values?', ['array', 'object', 'function'], 'array');
        const card3 = new Card(3, 'What type of prototype method directly modifies the existing array?', ['mutator method', 'accessor method', 'iteration method'], 'accessor method');
        const deck = new Deck([card1, card2, card3]);
    ...
    it('should update turns counter, evaluate guess, and give feedback', function() {
        ...
        const deck = new Deck([card1, card2, card3]);
        const round = new Round(deck);
        const turn2 = new Turns('array', {id: 2, question: 'What is a comma-separated list of related values?', answers: ['object', 'array', 'function'], correctAnswer: 'array'})
        
        round.takeTurn('object')
        round.takeTurn('function')
        expect(round.turnsCounter).to.equal(2)
